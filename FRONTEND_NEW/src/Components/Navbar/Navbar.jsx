                ...
                <ul className='hidden min-[420px]:flex gap-2 sm:gap-5 sm:text-sm text-xs md:text-lg font-semibold'>
...

                    {
                        user?.role === "admin" && (
                            <Link
                                to="/admin"
                                className="relative group text-[#111111] font-medium hover:text-[#C9A227] transition-all duration-300"
                            >
                                Admin

                                <span className="absolute left-0 -bottom-1 w-0 h-[2px] bg-[#C9A227] group-hover:w-full transition-all duration-300"></span>
                            </Link>
                        )
                    }
